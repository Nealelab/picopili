...
arg_indqc.add_argument('--min-chrx-snps',
                       type=int,
                       metavar='INT',
                       help='minimum number of chromosome X SNPs required to perform sex check',
                       required=False,
                       default=100), 
...
arg_snpqc.add_argument('--miss-th',
                       ...
                       required=False,
                       default=0.02)
arg_snpqc.add_argument('--skip-diff-miss',
                       action='store_true',
                       help='skip checks on differential missingness, e.g. if no case/control phenotype'), 
arg_snpqc.add_argument('--diff-miss-abs',
                       type=float,
                       metavar='FLOAT',
                       help='Absolute SNP differential missingness (case vs. control) threshold',
                       required=False,
                       default=0.02)
arg_snpqc.add_argument('--diff-miss-p',
                       type=float,
                       metavar='FLOAT',
                       help='p-value threshold for Fisher\'s exact test of differential missingness (case vs. control)',
                       required=False,
                       default=0.0)
