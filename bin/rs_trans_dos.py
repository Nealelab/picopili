...
bim_trans = {}
bim_names = []
bim_raw = open(str(outdot) + '.bg.tmp2.' + str(chname) + '.bim', 'r')
bim_out = open(str(outdot) + '.bg.' + str(chname) + '.bim_rsids', 'w')
for line in bim_raw:
...
info_out = open(str(outdot)+'.bg.'+str(chname)+'.info', 'w')
...
fam_in = open(str(outdot) + '.bg.tmp2.' + str(chname) + '.fam', 'r')
fam_out = open(str(outdot) + '.bg.' + str(chname) + '.fam_trans', 'w')
